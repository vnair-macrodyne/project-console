...
# custom-field layout (confirmed via tlkpCaption 2026-09-12 — dbo.tlkpCaption, Object='Part'):
#   PartCustom6 = "Date Released Engineering"   PartCustom7  = "Long Lead Item"
#   PartCustom8 = "Oversize Permit Required"    PartCustom14 = "Critical Path"
#   PartCustom17 = "Requires Inspection"
_LLT_FLAG_COL = "PartCustom7"; _OVERSIZE_FLAG_COL = "PartCustom8"; _ENG_RELEASE_COL = "PartCustom6"
_CRITICAL_COL = "PartCustom14"; _INSPECTED_COL = "PartCustom17"
...
def query_po_exceptions(include_leadtime=True, project_ids=None, date_from=None, date_to=None,
    ...
    # item flags: Critical Path (PartCustom14), Requires Inspection (PartCustom17); drawing number
    # is parsed from tblEngItemMaster.Drawing (stored as '<drawing>#<path>#') in the builder.
    crit_sel = f"eim.[{_CRITICAL_COL}]" if include_leadtime else "CAST(NULL AS bit)"
    ...
    SELECT
        ...
        {insp_sel}                      AS InspFlag,
        {draw_sel}                      AS DrawingRaw,
        {rfq_sel}                       AS RFQDate,
